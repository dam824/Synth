    ...
    <div className="synth-scroll mx-auto max-w-[1080px] px-6">
      ...
      <nav className="flex items-center justify-between py-[26px]">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/login"
            className="flex h-[38px] items-center rounded-[9px] px-[14px] text-[14px] font-medium text-[#46454C] transition hover:bg-black/5"
          >
            Se connecter
          </Link>
          <Link
            href={startHref}
            className="flex h-[38px] items-center rounded-[9px] bg-primary px-4 text-[14px] font-semibold tracking-[-0.01em] text-white transition hover:opacity-90"
          >
            Essayer SYNTH
          </Link>
        </div>
      ...
      <header className="mx-auto max-w-[760px] px-0 pb-[60px] pt-[74px] text-center">
        <div className="mb-7 inline-flex items-center gap-[7px] rounded-full border border-[#E4DCFB] bg-[#F1EEFB] px-[13px] py-[6px]">
          <span className="h-[6px] w-[6px] rounded-full bg-accent" />
          <span className="text-[12.5px] font-medium text-[#5A48B0]">
        ...
        <p className="mx-auto mb-9 max-w-[540px] text-[19px] leading-[1.55] text-[#5C5B63]">
        ...
        <div className="flex flex-wrap justify-center gap-[11px]">
          <Link
            href={startHref}
            className="inline-flex h-[50px] items-center gap-2 rounded-xl bg-primary px-[26px] text-[16px] font-semibold tracking-[-0.01em] text-white transition hover:opacity-90"
          >
            Poser ma première question →
          </Link>
          <a
            href="#how"
            className="inline-flex h-[50px] items-center rounded-xl border border-[#E2E0DA] bg-surface px-[22px] text-[16px] font-semibold text-foreground transition hover:bg-[#FAFAF8]"
          >
      ...
      <div className="mb-10 mt-2 overflow-hidden rounded-[18px] border border-border bg-surface shadow-preview">
        <div className="flex items-center gap-[7px] border-b border-[#F1EFEA] px-4 py-[13px]">
          <span className="h-[9px] w-[9px] rounded-full bg-[#E6E4DE]" />
          <span className="h-[9px] w-[9px] rounded-full bg-[#E6E4DE]" />
          <span className="h-[9px] w-[9px] rounded-full bg-[#E6E4DE]" />
        ...
        <div className="px-[30px] pb-[34px] pt-[30px]">
          <div className="mb-[18px] flex items-start gap-3 rounded-[13px] border border-border px-[18px] py-4">
            <span className="pt-[2px] font-mono text-[12px] text-[#9B99A1]">Q</span>
            <span className="text-[15.5px] text-[#3A3940]">
              Quelle structure juridique choisir pour lancer mon activité de
              freelance en France ?
            </span>
          </div>
          <div className="mb-[14px] flex items-center gap-[9px]">
            <span className="inline-flex items-center gap-[6px] rounded-full border border-[#D6EDDF] bg-[#EDF7F0] px-[11px] py-[5px] text-[12px] font-semibold text-[#1E7A48]">
              ● Confiance élevée
            </span>
          ...
          <p className="m-0 text-[15px] leading-[1.6] text-[#56555D]">
      ...
      <section id="how" className="px-0 pb-[30px] pt-16">
        <p className="m-0 mb-3 text-center font-mono text-[12px] tracking-[0.08em] text-[#9B99A1]">
          COMMENT ÇA MARCHE
        </p>
        ...
        <div className="grid grid-cols-1 gap-[18px] sm:grid-cols-3">
          {STEPS.map((s) => (
            ...
            >
              ...
              <p className="m-0 text-[14.5px] leading-[1.55] text-[#6B6A72]">
                {s.body}
              </p>
            </div>
          ))}
      ...
      <section className="px-0 pb-[30px] pt-[54px]">
        <div className="grid grid-cols-1 gap-[18px] sm:grid-cols-2">
          <div className="rounded-xl border border-border bg-[#F7F6F3] p-7">
            <p className="m-0 mb-4 font-mono text-[12px] text-faint">AVANT</p>
            <p className="m-0 mb-4 text-[17px] font-semibold text-[#46454C]">
              Vous jonglez entre les onglets.
            </p>
            <div className="flex flex-col gap-[9px]">
              <div className="h-[11px] w-[90%] rounded-[5px] bg-[#E8E6E0]" />
              <div className="h-[11px] w-[70%] rounded-[5px] bg-[#E8E6E0]" />
              <div className="h-[11px] w-[82%] rounded-[5px] bg-[#E8E6E0]" />
            </div>
            <p className="mb-0 mt-[18px] text-[14px] leading-[1.5] text-[#8A8890]">
              Trois réponses différentes. Laquelle croire ? Vous arbitrez seul.
            </p>
          </div>
          <div className="rounded-xl border border-[#E4DCFB] bg-surface p-7 shadow-accent">
            ...
            <div className="flex flex-col gap-[9px]">
              <div className="h-[11px] w-[95%] rounded-[5px] bg-primary" />
              <div className="h-[11px] w-[78%] rounded-[5px] bg-[#D8D6E8]" />
              <div className="h-[11px] w-[86%] rounded-[5px] bg-[#D8D6E8]" />
            </div>
            <p className="mb-0 mt-[18px] text-[14px] leading-[1.5] text-[#6B6A72]">
      ...
      <section className="px-0 pb-[30px] pt-10">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {EXAMPLES.map((ex) => (
            <div
              key={ex}
              className="rounded-[13px] border border-border bg-surface px-5 py-[18px] text-[15px] text-[#46454C]"
            >
              {ex}
            </div>
          ))}
      ...
      {/* CTA */}
      <section className="my-[50px] rounded-[22px] bg-primary px-8 py-[54px] text-center">
        <h2 className="m-0 mb-3 text-[34px] font-bold tracking-[-0.03em] text-white">
          Vous posez la question.
          <br />
          SYNTH s&apos;occupe du reste.
        </h2>
        <p className="mx-auto mb-7 max-w-[420px] text-[16px] text-[#A7A5AE]">
          Gratuit pour vos premières questions. Aucune carte requise.
        </p>
        <Link
          href={startHref}
          className="inline-flex h-[50px] items-center rounded-xl bg-white px-7 text-[16px] font-semibold tracking-[-0.01em] text-primary transition hover:opacity-90"
        >
          Demander à SYNTH
        </Link>
      </section>
